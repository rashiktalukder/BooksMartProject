    ...
    public partial class AddStoredProcForCoverType2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"CREATE PROC usp_GetCoverTypes 
                                    AS 
                                    BEGIN 
                                     SELECT * FROM   dbo.CoverTypesModel 
                                    END");
            ...
            migrationBuilder.Sql(@"CREATE PROC usp_GetCoverType 
                                    ...
                                    AS 
                                    BEGIN 
                                     SELECT * FROM   dbo.CoverTypesModel  WHERE  (Id = @Id) 
                                    END ");
            ...
            migrationBuilder.Sql(@"CREATE PROC usp_DeleteCoverType
                                    ...
                                    AS 
                                    BEGIN 
                                     DELETE FROM dbo.CoverTypesModel
                                     WHERE  Id = @Id
                                    END");
            ...
            migrationBuilder.Sql(@"CREATE PROC usp_CreateCoverType
                                   ...
                                   AS 
                                   BEGIN 
                                    INSERT INTO dbo.CoverTypesModel(Name)
                                    VALUES (@Name)
                                   END");
